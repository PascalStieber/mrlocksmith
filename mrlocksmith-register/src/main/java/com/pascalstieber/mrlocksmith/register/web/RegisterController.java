...
public class RegisterController {
	...
	public ModelAndView postContractor(@Valid Contractor contractor, BindingResult bindingResult,
		...
		return new ModelAndView(REDIRECT_ON_HOST + "quotation/" + contractor.getId());
	}
